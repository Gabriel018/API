...
using MED.Application.;
using MED.Domain.Entities;
using MED.Data.Repositories;

namespace MED.Application.Service
{
    public class ContatoService : IContatoService
    {
        ...
        {
            return _mapper.Map<IEnumerable<ContatoVM>>(_contatoRepository.AsQueryable().Where(p => p.IsAtivo == true));
        }
